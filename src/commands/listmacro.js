...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('listmacro')
        .setDescription('Submit a macro client to be listed in the forum'),
    
    async execute(interaction) {
        // Create the modal
        const modal = new ModalBuilder()
            .setCustomId('client_form_macro')
            .setTitle('Submit Macro Client');
        ...
        const nameInput = new TextInputBuilder()
            ...
            .setPlaceholder('Enter the name of the macro client')
            .setRequired(true)
            .setMaxLength(100);
